...
setup(
    ...
    description='Elasticsearch ECS library to take isolated metrics.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/Rockin2/python-elasticsearch-ecs-metrics',
    ...
    keywords='logging elasticsearch ecs metrics instrumentation',
